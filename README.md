...
**DESC:** A simple and fast clock and timer device created on the STM32F11 microcontoller using bare metal programming techniques with no abstraction and external contoller devices.
